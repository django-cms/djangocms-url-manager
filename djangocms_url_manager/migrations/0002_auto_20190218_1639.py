...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='url',
            name='internal_name',
            field=models.CharField(blank=True, help_text='Provide internal name for URL objects for searching purpose', max_length=255, null=True, verbose_name='internal name'),
        ),
        migrations.AddField(
